...
def read_frame_from_videos(frame_root):
    ...
    return frames, fps, size, video_name,frame_root
...
if __name__ == '__main__':
    ...
    frames, fps, size, video_name,filename = read_frame_from_videos(args.video)
    ...
    save_root = os.path.join(args.output, filename)
